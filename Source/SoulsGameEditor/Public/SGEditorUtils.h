...
public:
	...
	static void GenerateStructsFromJson(struct FSGAnimationFileReaderEvent & ReaderObject, TSharedPtr<FJsonObject> JsonObject);
	static void GenerateStructsFromJson(struct FSGAnimationFileReaderAnimNotify & ReaderObject, TSharedPtr<FJsonObject> JsonObject);
