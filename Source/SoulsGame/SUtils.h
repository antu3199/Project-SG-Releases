...
public:
    ...
    static void StopTimeForCharacter(const UObject* WorldContextObject, class ASCharacterBase* Character);
    static void ResumeTimeForCharacter(const UObject* WorldContextObject, class ASCharacterBase* Character);
    ...
    static ASCharacterBase* GetClosestTeamCharacterFromLocation(const UWorld* World, FVector Location, ESGTeam Team, float MaxDistance = -1, bool bCreateDebugSphere = false, bool bIgnoreDisabledActors = true);
