...
bool
USimpleLevelManagerSubsystem::LoadStreamingLevel( FName LevelName, bool bMakeVisible)
{
...
void USimpleLevelManagerSubsystem::LoadAllStreamingLevels()
{
...
void USimpleLevelManagerSubsystem::OnStreamingLevelLoadedForLoadAll(FName Name)
{
   CurrentlyLoadedPendingLevels++;
