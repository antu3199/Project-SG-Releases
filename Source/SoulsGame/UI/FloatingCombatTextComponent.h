...
class SOULSGAME_API UFloatingCombatTextComponent : public UActorComponent
{
	GENERATED_BODY()
public:
...
private:
	...
	TSubclassOf<class AFloatingTextActor> FloatingTextActorClass = nullptr;
	...
	UPROPERTY(Transient)
	TArray<class AFloatingTextActor*> ActiveTextActors;
};
