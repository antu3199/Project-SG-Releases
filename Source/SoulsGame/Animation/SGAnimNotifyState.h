...
#include "SoulsGame/Character/SGHumanoidPlayerCharacter.h"

#include "SGAnimNotifyState.generated.h"
 ...
 */
UCLASS()
class SOULSGAME_API USGAnimNotifyState : public UAnimNotifyState
{
	GENERATED_BODY()
...
protected:
	...
	virtual ASGCharacterBase* GetCharacter(USkeletalMeshComponent* MeshComp);
	
	virtual ASGHumanoidCharacter* GetHumanoidCharacter(USkeletalMeshComponent* MeshComp);

	virtual ASGHumanoidPlayerCharacter* GetHumanoidPlayerCharacter(USkeletalMeshComponent* MeshComp);
