...
#include "SGAnimNotifyState_ConvertToWorldSpaceRotation.h"


#include "GeometryCollection/GeometryCollectionAlgo.h"
#include "Kismet/KismetMathLibrary.h"

void USGAnimNotifyState_ConvertToWorldSpaceRotation::DoNotifyBegin(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation,
                                                   float TotalDuration)
{
...
void USGAnimNotifyState_ConvertToWorldSpaceRotation::DoNotifyEnd(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
...
void USGAnimNotifyState_ConvertToWorldSpaceRotation::NotifyTick(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation,
...
FTransform USGAnimNotifyState_ConvertToWorldSpaceRotation::GetBoneTransFromMontage(UAnimMontage* InMontage, FName BoneName, float InTime)
{    
...
FQuat USGAnimNotifyState_ConvertToWorldSpaceRotation::GetRotationFromAnimation(const FTransform& Transform) const
{
	return Transform.GetRotation() * FQuat::MakeFromEuler(FVector(90, 0, -180));
}

void USGAnimNotifyState_ConvertToWorldSpaceRotation::DoRotation(USkeletalMeshComponent* MeshComp, float TestTime)
{
