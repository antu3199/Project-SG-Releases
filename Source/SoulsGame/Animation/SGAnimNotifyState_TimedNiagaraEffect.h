...
#include "SGAnimNotifyState_TimedNiagaraEffect.generated.h"

UCLASS(Blueprintable, meta = (DisplayName = "SG Timed Niagara Effect"))
class SOULSGAME_API USGAnimNotifyState_TimedNiagaraEffect : public UAnimNotifyState_TimedNiagaraEffect
{
public:
